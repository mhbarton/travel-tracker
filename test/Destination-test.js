...
describe('Destination', () => {
  ...
  beforeEach(() => {
    ...
    destination3 = new Destination ({
      ...
      a                   alt: "opera house and city buildings on the water with boats"
                        });
  ...
  it('Should have an estimated cost of flight per person', () => {
    expect(destination1.estimatedFlightCost).to.equal(70);
    expect(destination2.estimatedFlightCost).to.equal(100);
  });
